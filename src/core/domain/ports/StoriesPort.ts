...
import type { BasicInfo, RegisterStory, StoryInfo, UpdateStory, UserFilters } from "../models/stories/StoryModel";
...
export interface StoryPort {
    ...
    getLastModifiedStory(userId: string): Promise<StoryInfo>;
