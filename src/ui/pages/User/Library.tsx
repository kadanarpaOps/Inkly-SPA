...
export default function Library() {
    ...
    const [mode, setMode] = useState<LibraryMode>("mine");
    const [expandedFilters, setExpandedFilters] = useState(false);

    // Search instances for each mode
    const searchMine = useSearchStories("myStories");
    const searchSaved = useSearchStories("saved");

    // Select the appropriate search instance based on mode
    const currentSearch = mode === "mine" ? searchMine : searchSaved;
    const { searchForm, results, loading, handleSearch, resetSearch } = currentSearch;
        ...
        <main className="relative h-full">
            <div className="min-h-screen bg-background-global py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Header */}
                    <div className="mb-12">
                        <h1 className="text-4xl font-bold text-global mb-6">Mi Biblioteca</h1>

                        {/* Mode Switch */}
                        <div className="flex space-x-4 border-b border-toolbar-bg/10">
                            <button
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
                                {results.data.length > 0 ? (
                                    ...
                                    <div className="col-span-full flex items-center justify-center py-12">
                                        <p className="text-several-light">
                                            {mode === "mine"
