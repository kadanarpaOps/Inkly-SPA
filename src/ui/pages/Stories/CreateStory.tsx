        ...
        <div className="max-w-6xl mx-auto px-8 py-12">
          <div className="flex flex-col lg:flex-row gap-16">
            <aside className="w-full lg:w-1/3 flex flex-col items-center">
              <div className="relative group w-full max-w-75 aspect-2/3 rounded-xl glass-ghost flex flex-col items-center justify-center text-center p-8 bg-surface-container-low overflow-hidden transition-all hover:bg-surface-container-high">
                ...
                <div className="z-10 flex flex-col items-center">
                  ...
                  <button className="cursor-pointer px-6 py-3 bg-on-surface text-surface rounded-full font-bold text-sm tracking-wide hover:scale-105 transition-transform active:scale-95 shadow-lg">
                    Subir Portada
                  </button>
                </div>
              ...
              <form action="" className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <button className="cursor-pointer w-full flex items-center justify-between bg-surface-container-low glass-ghost px-6 py-4 rounded-xl hover:bg-surface-container-high transition-colors text-on-surface" type="button">
                ...
                <div className="mt-10 flex items-center justify-end border-t border-outline-variant/10">
                  <button className="text-on-surface-variant font-semibold px-8 py-4 mr-6 hover:text-primary transition-colors cursor-pointe cursor-pointer">
                    Cancelar
                  </button>
                  <button
